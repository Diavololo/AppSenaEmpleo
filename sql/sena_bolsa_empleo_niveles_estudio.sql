...
LOCK TABLES `niveles_estudio` WRITE;
/*!40000 ALTER TABLE `niveles_estudio` DISABLE KEYS */;
INSERT INTO `niveles_estudio` VALUES (1,'Bachiller'),(5,'Posgrado'),(4,'Profesional'),(2,'Técnico'),(3,'Tecnólogo');
/*!40000 ALTER TABLE `niveles_estudio` ENABLE KEYS */;
UNLOCK TABLES;
